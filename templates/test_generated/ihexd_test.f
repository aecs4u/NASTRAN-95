...
C     DISPLACEMENT VECTOR POINTER IS NON-0.0D0, THE DIFFERENTIAL
...
C
C     IZ    NGG BY 3 PARTITION  NGG BY 3 PARTITION  4.0D0 WORD COORDINATE
...
C                                                   MATION MATRIX
C
C     IK    SYMMETRIC 0.5D0 OF   SAME AS IZ          FULL CONDUCTANCE
C           STIFFNESS
C
C     IM    SYMMETRIC 0.5D0 OF   SYMMETRIC 0.5D0 OF   FULL CAPACITANCE
C           MASS                MASS
C
...
C
C     0.0D0 OUT OPEN CORE FOR MATRIX SUMMATION
C
      DO 580 I = IK,NM
  580 Z(I) = 0.0
C
...
C
C     TRANSFORM COORDINATE SYSTEM OF SYMMETRIC 0.5D0 OF A 3 BY 3 MATRIX
C
