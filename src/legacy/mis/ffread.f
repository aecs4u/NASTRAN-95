...
C
      MACH = MCHN
C     DEBUG: FFREAD entry - check IN value
      IF (NCARD .EQ. 0) THEN
        PRINT *, '>>> FFREAD ENTRY: IN=', IN, ' INFLAG=',INFLAG,' MACH=',MACH
      ENDIF
...
C
 ...
 210  FORMAT (7H ENTER )
C     DEBUG: Check IN value before READ
      WRITE (6,*) '>>> FFREAD: About to READ, IN=', IN, ' INFLAG=',INFLAG
      WRITE (6,*) '>>> FFREAD: MACH=', MACH, ' L94=', L94
      CALL FLUSH(6)
      READ   (IN,220,END=190) (CX(J),J=1,L94)
 220  FORMAT (94A1)
C     DEBUG: Print raw card content after read
      WRITE (6,*) '=== FFREAD DEBUG: Card #', NCARD+1, ' ==='
      WRITE (0,221) (CX(J),J=1,80)
 221  FORMAT (' First 80 chars: |',80A1,'|')
      WRITE (0,222) (CX(J),J=81,94)
 222  FORMAT (' Last 14 chars:  |',14A1,'|')
      WRITE (6,*) 'ASCII values (1-80):'
      WRITE (0,223) (ICHAR(CX(J)),J=1,80)
 223  FORMAT (10(8I4,/))
      WRITE (6,*) 'ASCII values (81-94):'
      WRITE (0,224) (ICHAR(CX(J)),J=81,94)
 224  FORMAT (14I4)
      CALL FLUSH(6)
      NCARD = NCARD + 1
      LASH  = 0
